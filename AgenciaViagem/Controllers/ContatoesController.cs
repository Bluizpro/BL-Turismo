...
namespace AgenciaViagem.Controllers
{
    public class ContatoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,CPF,Endereco,Bairro,Cidade,Telefone,Destino,Nascimento")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,CPF,Endereco,Bairro,Cidade,Telefone,Destino,Nascimento")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
